# chickenstats_api.GameStatsApi

All URIs are relative to *https://api.chickenstats.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**chicken_nhl_create_stats**](GameStatsApi.md#chicken_nhl_create_stats) | **POST** /api/v1/chicken_nhl/stats | Create Stats
[**chicken_nhl_read_game_stats**](GameStatsApi.md#chicken_nhl_read_game_stats) | **GET** /api/v1/chicken_nhl/stats/game | Read Game Stats
[**chicken_nhl_read_stats_game_ids**](GameStatsApi.md#chicken_nhl_read_stats_game_ids) | **GET** /api/v1/chicken_nhl/stats/game_ids | Read Stats Game Ids
...
with chickenstats_api.ApiClient(configuration) as api_client:
    ...
    api_instance = chickenstats_api.GameStatsApi(api_client)
    stats_create = chickenstats_api.StatsCreate() # StatsCreate | 

    try:
        # Create Stats
        api_response = api_instance.chicken_nhl_create_stats(stats_create)
        print("The response of GameStatsApi->chicken_nhl_create_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GameStatsApi->chicken_nhl_create_stats: %s\n" % e)
```
...
with chickenstats_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GameStatsApi->chicken_nhl_read_game_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GameStatsApi->chicken_nhl_read_game_stats: %s\n" % e)
```
...
with chickenstats_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GameStatsApi->chicken_nhl_read_stats_game_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GameStatsApi->chicken_nhl_read_stats_game_ids: %s\n" % e)
```
