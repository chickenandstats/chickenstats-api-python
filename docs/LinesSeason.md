...
json = "{}"
# create an instance of LinesSeason from a JSON string
lines_season_instance = LinesSeason.from_json(json)
# print the JSON string representation of the object
print(LinesSeason.to_json())

# convert the object into a dict
lines_season_dict = lines_season_instance.to_dict()
# create an instance of LinesSeason from a dict
lines_season_from_dict = LinesSeason.from_dict(lines_season_dict)
```
