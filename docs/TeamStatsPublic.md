...
team_stats_public_instance = TeamStatsPublic.from_json(json)
# print the JSON string representation of the object
print(TeamStatsPublic.to_json())

# convert the object into a dict
team_stats_public_dict = team_stats_public_instance.to_dict()
# create an instance of TeamStatsPublic from a dict
team_stats_public_from_dict = TeamStatsPublic.from_dict(team_stats_public_dict)
```
