...
lines_create_instance = LinesCreate.from_json(json)
# print the JSON string representation of the object
print(LinesCreate.to_json())

# convert the object into a dict
lines_create_dict = lines_create_instance.to_dict()
# create an instance of LinesCreate from a dict
lines_create_from_dict = LinesCreate.from_dict(lines_create_dict)
```
