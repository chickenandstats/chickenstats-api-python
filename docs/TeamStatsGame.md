...
json = "{}"
# create an instance of TeamStatsGame from a JSON string
team_stats_game_instance = TeamStatsGame.from_json(json)
# print the JSON string representation of the object
print(TeamStatsGame.to_json())

# convert the object into a dict
team_stats_game_dict = team_stats_game_instance.to_dict()
# create an instance of TeamStatsGame from a dict
team_stats_game_from_dict = TeamStatsGame.from_dict(team_stats_game_dict)
```
