...
json = "{}"
# create an instance of TeamStatsSeason from a JSON string
team_stats_season_instance = TeamStatsSeason.from_json(json)
# print the JSON string representation of the object
print(TeamStatsSeason.to_json())

# convert the object into a dict
team_stats_season_dict = team_stats_season_instance.to_dict()
# create an instance of TeamStatsSeason from a dict
team_stats_season_from_dict = TeamStatsSeason.from_dict(team_stats_season_dict)
```
