...
stats_season_instance = StatsSeason.from_json(json)
# print the JSON string representation of the object
print(StatsSeason.to_json())

# convert the object into a dict
stats_season_dict = stats_season_instance.to_dict()
# create an instance of StatsSeason from a dict
stats_season_from_dict = StatsSeason.from_dict(stats_season_dict)
```
