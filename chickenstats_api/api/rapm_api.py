...
class RapmApi:
    ...
    def read_rapm(
        ...
        situation: Optional[List[StrictStr]] = None,
        ...
        pos: Optional[List[StrictStr]] = None,
        ...
        _param = self._read_rapm_serialize(
            season=season,
            sessions=sessions,
            situation=situation,
            player=player,
    ...
    @validate_call
    def read_rapm_without_preload_content(
        self,
        season: Optional[List[StrictInt]] = None,
        sessions: Optional[List[StrictStr]] = None,
        situation: Optional[List[StrictStr]] = None,
    ...
    def _read_rapm_serialize(
        ...
        if situation is not None:
            ...
            _query_params.append(('situation', situation))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/chicken_nhl/rapm',
