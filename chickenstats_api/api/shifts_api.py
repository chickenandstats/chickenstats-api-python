...
class ShiftsApi:
    ...
    def read_shifts(
        ...
        _param = self._read_shifts_serialize(
            season=season,
            sessions=sessions,
            game_id=game_id,
            api_id=api_id,
    ...
    @validate_call
    def read_shifts_with_http_info(
        self,
        season: Optional[List[StrictInt]] = None,
        sessions: Optional[List[StrictStr]] = None,
        game_id: Optional[List[StrictInt]] = None,
    ...
    @validate_call
    def read_shifts_without_preload_content(
        self,
        season: Optional[List[StrictInt]] = None,
        sessions: Optional[List[StrictStr]] = None,
        game_id: Optional[List[StrictInt]] = None,
    ...
    def _read_shifts_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/chicken_nhl/shifts',
    ...
    def read_shifts_game_ids(
        ...
        _param = self._read_shifts_game_ids_serialize(
            season=season,
            sessions=sessions,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def read_shifts_game_ids_with_http_info(
        self,
        season: Optional[List[StrictInt]] = None,
        sessions: Optional[List[StrictStr]] = None,
        limit: Optional[Annotated[int, Field(le=50000, strict=True, ge=1)]] = None,
    ...
    @validate_call
    def read_shifts_game_ids_without_preload_content(
        self,
        season: Optional[List[StrictInt]] = None,
        sessions: Optional[List[StrictStr]] = None,
        limit: Optional[Annotated[int, Field(le=50000, strict=True, ge=1)]] = None,
    ...
    def _read_shifts_game_ids_serialize(
        self,
        season,
        sessions,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/chicken_nhl/shifts/game_ids',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
